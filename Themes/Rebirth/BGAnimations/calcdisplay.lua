...
local plotWidth, plotHeight = capWideScale(300,579), 160
local plotX, plotY = oldWidth+3 + plotWidth/2, -96 + plotHeight/2
local highest = 0
local lowest = 0
...
local o =
    ...
    InitCommand = function(self)
        self:SetUpdateFunction(function()
            --self:GetChild("Unnamed"):queuecommand("Highlight")
            self:GetChild("G1BG"):queuecommand("Highlight")
...
o[#o + 1] = UIElements.QuadButton(1, 1) .. {
    ...
    HighlightCommand = function(self)
		...
		local bar = self:GetParent():GetChild("Seek1")
        local txt = self:GetParent():GetChild("Seektext1")
        local bg = self:GetParent():GetChild("Seektext1BG")
        if isOver(self) then
            local mx = INPUTFILTER:GetMouseX()
            local ypos = INPUTFILTER:GetMouseY() - self:GetParent():GetY()
...
o[#o+1] = LoadFont("Common Normal") .. {
    Name = "G2Group",
    InitCommand = function(self)
        self:xy(-plotWidth/2 + 2, plotHeight/2 + gap + 12)
        self:halign(0)
        self:zoom(0.25)
...
--o[#o + 1] = LoadFont("Common Normal") .. {
--    InitCommand = function(self)
--        self:xy(-plotWidth/4, plotHeight + gap + 5 + plotHeight/2 + 35)
--        self:zoom(0.55)
--        self:settext("")
...
o[#o + 1] = LoadFont("Common Normal") .. {
    InitCommand = function(self)
        self:xy(-plotWidth/2 + 30, plotHeight/2 + gap + 12):halign(0)
...
o[#o + 1] = Def.Quad {
    Name = "Seektext1BG",
    InitCommand = function(self)
        self:y(8+ gap+25):valign(1):halign(1):draworder(1100):diffuse(color("0,0,0,.4")):zoomto(20,20)
    end
}
...
o[#o + 1] = LoadFont("Common Normal") .. {
    Name = "Seektext1",
    InitCommand = function(self)
        self:y(8+ gap+25):valign(1):halign(1):draworder(1100):diffuse(color("1,1,1")):zoom(0.4)
    end,
...
o[#o + 1] = Def.Quad {
    Name = "Seektext2BG",
    InitCommand = function(self)
        self:y(8 + plotHeight + gap +5):valign(1):halign(1):draworder(1100):diffuse(color("0,0,0,.4")):zoomto(20,20)
    end
}
...
o[#o + 1] = LoadFont("Common Normal") .. {
    Name = "Seektext2",
    InitCommand = function(self)
        self:y(8 + plotHeight + gap +5):valign(1):halign(1):draworder(1100):diffuse(color("1,1,1")):zoom(0.4)
    end
}
...
o[#o + 1] = LoadFont("Common Normal") .. {
    ...
    InitCommand = function(self)
        self:y(8 + plotHeight + gap +5):halign(1):draworder(1100):diffuse(color("1,1,1")):zoom(0.5):maxheight(500)
    end
}
